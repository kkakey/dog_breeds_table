...
t <- reactable(
  ...
  columns = list(
      ...
      `Energy Level` = colDef(class="verticalcenter",
                              cell = function(value) rating_sys(value, "paw")),
      `Affectionate With Family` = colDef(class="verticalcenter",
      ...
      `Good With Other Dogs` = colDef(class="verticalcenter",
                                      cell = function(value) rating_sys(value, "dog")),
      `Barking Level` = colDef(class="verticalcenter",
                               cell = function(value) rating_sys(value, "volume-up")),
      `Trainability Level` = colDef(class="verticalcenter"),
      `Openness To Strangers` = colDef(class="verticalcenter"),
...
div(
    ...
    img(src="/Users/kristenakey/Downloads/dog.png", 
        alt = "dog icon from https://www.flaticon.com/free-icon/dog_2064847", 
        height=30, width=30)),
